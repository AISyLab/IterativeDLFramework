...
class Framework:
    ...
    def train_sets(self):
        ...
        if self.z_norm:
            self.create_z_score_norm(profiling_samples)
            self.apply_z_score_norm(profiling_samples)

        training_dataset_reshaped = profiling_samples.reshape((profiling_samples.shape[0], profiling_samples.shape[1], 1))

        x_set1 = training_dataset_reshaped[0:self.target_params["n_set1"]]
        x_set2 = training_dataset_reshaped[self.target_params["n_set1"]:self.target_params["n_set1"] + self.target_params["n_set2"]]
        ...
        return x_set1, x_set2, set1_samples, set2_samples, y_set1, y_set2
    ...
    def run(self):
        ...
        x_train, x_val, train_samples, val_samples, train_data, validation_data = self.train_sets()
    ...
    def run_iterative(self, n_iterations=50, data_augmentation=None, visualization=False, equal_size_traces=True):
        ...
        x_set1, x_set2, set1_samples, set2_samples, set1_data, set2_data = self.train_sets()
